...
scanf_fmt:
	.asciz "%d %d"
	.align	2
le_msg:	.asciz "%d + %d is less than equal to 7\n"
	.align	2
gt_msg:	.asciz "%d + %d is greater than 7\n"
...
main:
	...
	ldr	r0, [fp, #-12]	@ if y + x > 7
	ldr	r1, [fp, #-8]	
	add	r0, r0, r1
	cmp	r0, #7
	ble	else
	ldr	r0, gt_msgP	@ then print less-than message
	ldr	r1, [fp, #-8]	
	ldr	r2, [fp, #-12]	
	bl	printf
	b	next
	...
	ldr	r0, le_msgP	@ else print greater-than/equal-to message
	ldr	r1, [fp, #-8]	
	ldr	r2, [fp, #-12]	
	bl	printf
