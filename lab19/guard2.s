...
scanf_fmt:
	.asciz "%d %d"
	.align	2
le_msg:	.asciz "%d is less than %d\n"
	.align	2
gt_msg:	.asciz "%d is greater than equal to %d\n"
...
main:
	...
	cmp	r0, r1		
	ble	else
	ldr	r0, le_msgP	@ then print less-than message
	ldr	r1, [fp, #-8]	
	ldr	r2, [fp, #-12]	
	bl	printf
	b	next
	...
	ldr	r0, gt_msgP	@ else print greater-than/equal-to message
	ldr	r1, [fp, #-8]	
	ldr	r2, [fp, #-12]	
	bl	printf
